...
31. 
32. 工程应变=$\varepsilon(X,t)=F(X,t)-I=\frac{\partial u}{\partial X}$。当$t=0$时，$\varepsilon(X,0)=0$。
33. 
34. 
35. 
36. 
37. 
38. 
39. 位移和变形的关系：变形可以看作是位移的导数，因此大变形和大位移并没有必然的联系。
...
69. 
70. 
71. 最小作用量原理也被称作平稳作用量原理，实际上不一定要求是最小。只需要作用量这个泛函的一阶变分为零。
...
8. 两个特殊的拓扑空间：
   ...
   2. 零距拓扑：拓扑集中只有两个元素就是$X$本身和空集$\varnothing$，是元素最少的拓扑空间。
...
11. R中的任意开区间的并对于零距拓扑空间不是开集，因为零距拓扑空间只有2个元素，并不包含任意的开区间，对于离散拓扑空间是开集，因为任意开集都是离散拓扑空间中的元素。
12. 例子：
    1. $X=\{1,2,3,4\}$，则零距拓扑空间为$\mathscr{T}=\{X,\varnothing\}$。
...
14. <img src="E:\Markdown-file\assets\image-20231110194745360.png" alt="image-20231110194745360" style="zoom: 67%;" />
...
17. <img src="E:\Markdown-file\assets\image-20231110201526528.png" alt="image-20231110201526528" style="zoom:67%;" />
...
7. <img src="E:\Markdown-file\assets\image-20231110220017855.png" alt="image-20231110220017855" style="zoom:80%;" />
...
16. ![image-20231110231952355](E:\Markdown-file\assets\image-20231110231952355.png)
...
1. 应该先VS，再安装Intel Fortran，这样Intel Fortran会自动关联到VS，可以在vs中新建Fortran的项目。
   ...
   3. ![image-20231119192822828](E:\Markdown-file\有限元.assets\image-20231119192822828.png)
   4. 每个Intel Fortran编译器都有配合的多个VS版本，本机提前安装其中一个即可。
   5. ![image-20231119192839587](E:\Markdown-file\有限元.assets\image-20231119192839587.png)
   6. 亲测abaqus2023 + vs2019 + Intel oneAPI2024.0可以搭配。

2. Abaqus，VS和Intel Fortran Compiler兼容性列表。

3. <img src="E:\Markdown-file\有限元.assets\Fortran-Visual-Studio-Compatibility-Table-725x815.jpg" alt="Fortran-Visual-Studio-Compatibility-Table-725x815" style="zoom:67%;" />

4. <img src="E:\Markdown-file\有限元.assets\image-20231119192854754.png" alt="image-20231119192854754" style="zoom:67%;" />

5. Intel Parallel Studio XE 已经不更新了，被新的Intel oneAPI替代了。
...
14. 数值求解的步骤：首先已知量为：第k步的总应变$\varepsilon_k$，应力$\sigma_k$，
