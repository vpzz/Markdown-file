...
23. <img src="汇编语言.assets/image-20210526014702262.png" alt="image-20210526014702262" />
...
44. <img src="汇编语言.assets/image-20210526030447608.png" alt="image-20210526030447608" />
45. 具体G表示那个寄存器，是由ModR/M中的第二部分，即3-5位确定的。一共有8种情况。
46. <img src="汇编语言.assets/image-20210526030955366.png" alt="image-20210526030955366" />
47. 具体E表示那个寄存器还是内存单元，有ModR/M中的第1和3部分确定。
48. 3-5位不仅可以用来标识寄存器，还可以作为opcode的扩展。
49. SiB字节也分为3个部分，表示了一种复杂的寻址方式。
50. <img src="汇编语言.assets/image-20210526034815014.png" alt="image-20210526034815014" />
...
16. <img src="汇编语言.assets/image-20210529114607462.png" alt="image-20210529114607462" />
...
22. <img src="汇编语言.assets/image-20210529125847760.png" alt="image-20210529125847760" />

23. 可以使用的数据类型：

24. <img src="汇编语言.assets/image-20210529130004137.png" alt="image-20210529130004137" />
...
35. <img src="汇编语言.assets/image-20210530225611990.png" alt="image-20210530225611990" />

36. 在data节中占据一块内容，在bss节中声明一块内容：.fill是重复的意思，默认是1个字节，值为0。

37. <img src="汇编语言.assets/image-20210530230117810.png" alt="image-20210530230117810" />
...
42. <img src="汇编语言.assets/image-20210530234101676.png" alt="image-20210530234101676" />
...
47. <img src="汇编语言.assets/image-20210531003438457.png" alt="image-20210531003438457" />
...
53. <img src="汇编语言.assets/image-20210601011944087.png" alt="image-20210601011944087" />
...
56. <img src="汇编语言.assets/image-20210601013532768.png" alt="image-20210601013532768" />
...
69. <img src="汇编语言.assets/image-20210601180142447.png" alt="image-20210601180142447" />
...
92. <img src="汇编语言.assets/image-20210602195331877.png" alt="image-20210602195331877" />
...
3. <img src="汇编语言.assets/image-20210601183949350.png" alt="image-20210601183949350" />
4. $S=A\otimes B$，$C=AB$。
5. <img src="汇编语言.assets/image-20210601194805290.png" alt="image-20210601194805290" />
...
9. <img src="汇编语言.assets/image-20210601195935347.png" alt="image-20210601195935347" />
10. <img src="汇编语言.assets/image-20210601195021001.png" alt="image-20210601195021001" />
11. 四位二进制全加器，采用串行(后一位的计算必须要等到前一位计算完成再开始。)进位。两个数分别为$A_3A_2A_1A_0$和$B_3B_2B_1B_0$。
12. <img src="汇编语言.assets/image-20210601200757108.png" alt="image-20210601200757108" />
13. 加减法器：可以将最低位的输入进位当做控制位，为0时表示要做加法，为1时表示要做减法。做减法时，应该讲B取反加1。而加1可以用加控制位来代替。所以只要取反即可。
14. <img src="汇编语言.assets/image-20210602130422661.png" alt="image-20210602130422661" />
...
16. <img src="汇编语言.assets/image-20210602123958240.png" alt="image-20210602123958240" />
19. 为了克服串行进位加法器速度慢的缺点，开发出了超前进位加法器，可以根据每一位的待机算数直接判断出进位与否。电路复杂度换时间。
20. <img src="汇编语言.assets/image-20210601201750057.png" alt="image-20210601201750057" />
21. 改进全加器运算公式的形式：
22. <img src="汇编语言.assets/image-20210601204454777.png" alt="image-20210601204454777" />
23. 展开递推式，可以建立$A_i,B_i,C_0$和$S_i,C_i$的关系。可以看出来，有些部分被重复计算了。
24. <img src="汇编语言.assets/image-20210601204750432.png" alt="image-20210601204750432" />
25. 使用加法器实现减法器。$A-B$等价于$A+B_补$。正数的补码就是它本身，负数的补码是按位取反再加1。
26. 可以利用多路复用器来实现移位的功能。
27. RISC的十种基本逻辑运算：
28. <img src="汇编语言.assets/image-20210601234711198.png" alt="image-20210601234711198" />
29. ALU的基本结构，两个运算输入，一个控制输入opcode，一个结果输出。
30. <img src="汇编语言.assets/image-20210601234634700.png" alt="image-20210601234634700" />
